<html>
						<div class="header">
						<div class="logo"><img src="theme/assets/pirates_back.png" width= "800" height= "300"></div>
						<nav class="navbar navbar-inverse">
						  <div class="container-fluid">
							<div class="navbar-header">
							<div class="logo"><img src="theme/assets/piratesflag.png" width= "50" height= "50"></div>
							</div>
